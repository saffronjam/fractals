...
enum class JuliaState { Animate, FollowCursor, None };
...
class Julia : public FractalSet {
  public:
    ...
    void SetC(const std::complex<double>& c, bool animate);
    void SetCr(double r, bool animate);
    void SetCi(double i, bool animate);
