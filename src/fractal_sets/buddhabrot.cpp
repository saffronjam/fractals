...
Buddhabrot::Buddhabrot(const sf::Vector2f& renderSize)
    ...
    std::generate_n(std::back_inserter(_points), nPoints, [] { return Random::Vec2(0.0, 0.0, 1.0, 1.0); });
    ...
    comHost->RequestUniformUpdate.Subscribe([this](ComputeShader& computeShader) {
