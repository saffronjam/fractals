...
#include "fractal_sets/buddhabrot.h"
#include "fractal_sets/julia.h"
#include "fractal_sets/mandelbrot.h"
#include "fractal_sets/polynomial.h"

namespace fractals {
using namespace saffron;
enum class FractalGenerationPrecision { Bit32, Bit64 };
...
class FractalManager {
  ...
  private:
    ...
    void MoveCameraTo(Position position, double zoom);
    void ResetCamera();
    auto CalculateZoomTransitionDuration(double startZoom, double desiredZoom) const -> double;
