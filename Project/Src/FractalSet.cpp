...
FractalSet::FractalSet(String name, Type type, sf::Vector2f renderSize) :
	...
	_palettes(4)
{
	_palettes[Fiery] = ImageStore::GetCopy("Resources/Pals/fiery.png");
	_palettes[UV] = ImageStore::GetCopy("Resources/Pals/uv.png");
	_palettes[GreyScale] = ImageStore::GetCopy("Resources/Pals/greyscale.png");
	_palettes[Rainbow] = ImageStore::GetCopy("Resources/Pals/rainbow.png");
